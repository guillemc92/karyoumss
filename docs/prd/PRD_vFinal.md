...
**5.4 Épica E4 – Bloqueo y reglas de negocio (BR-R1, BR-R2, BR-R5, BR-03)**

| ID | Historia | Prioridad | Valor | Esfuerzo | Criterios Gherkin |
| :---- | :---- | :---- | :---- | :---- | :---- |
| PRD-US-008 | Como Analista, quiero que el sistema me impida generar un informe si hay cromosomas naranja sin resolver para evitar errores médicos y cumplir RN-09 / BR-R5 | Must | 10 | 3 | ver §5.4.1 |
...
| PRD-REQ-005 | BR-03, BR-R1, BR-R5 | PRD-US-008 | FSD-UC-004 |
