...
`Y el sistema impide pasar a Supervisor o generar reporte mientras exista al menos un cromosoma naranja no validado`
* Precondiciones:  
...
* Precondiciones:  
  ...
  2. Todos los cromosomas naranja han sido validados explícitamente por el Analista.  
...
| BR-R5 | Control de no emisión: no se genera ni exporta el informe final si existe al menos un cromosoma con confidence_score <85% sin validación explícita del Analista. Requiere firma del Supervisor para emisión. | política | RN-09 / BR-R5 | FSD-UC-004, FSD-UC-006 |
